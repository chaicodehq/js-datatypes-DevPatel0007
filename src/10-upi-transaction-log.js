...
export function analyzeUPITransactions(transactions) {
  ...
  const highestTransaction = validTransactions.reduce((highest, txn) => txn.amount > highest.amount ? txn : highest, validTransactions[0]);
  ...
  const frequentContact = Object.entries(contactFrequency).reduce((mostFrequent, [contact, freq]) => freq > mostFrequent.freq ? { contact, freq } : mostFrequent, { contact: null, freq: -Infinity }).contact;
